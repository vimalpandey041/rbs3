...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/syllabus.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/slider.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/department-page.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/faculty.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/placement.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/lightbox.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/route.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/gallery.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/gallery2.css')?>">
  <link rel="stylesheet" href="<?php echo base_url('assets/css/craousel.css')?>">
...
<body>
  <div class="container-fluid  bg-primary d-none d-sm-block">
    <div class="row">
      <div class="col-sm-4  py-2  d-flex justify-content-center align-items-center text-white">

        <i class="fa-solid fa-phone px-3"></i>
        <a href="tel: +91<?php echo $display_top_header['number']?>" class="nav-link">+91 <?php echo $display_top_header['number']?></a>

      </div>
      <div class="col-sm-5 py-2  d-flex justify-content-center align-items-center text-white">
        <i class="fa-solid fa-envelope px-3"></i>
        <a href="mailto:<?php echo $display_top_header['email']?>" class="nav-link"><?php echo $display_top_header['email']?></a>

      </div>
      <div class="col-sm-3 py-2  d-flex justify-content-center align-items-center text-white">
        <a href="<?php echo $display_top_header['facebook']?> "><i class="fa-brands text-white fa-facebook px-2"></i></a>
        <a href="<?php echo $display_top_header['twitter']?> "><i class="fa-brands text-white fa-twitter px-2"></i></a>
        <a href="<?php echo $display_top_header['instagram']?> "><i class="fa-brands text-white fa-instagram px-2"></i></a>
        <a href="<?php echo $display_top_header['linkedin']?> "><i class="fa-brands text-white fa-linkedin px-2"></i></a>


      </div>
      
      <!-- <div class="col-sm-3 py-2 d-none d-flex justify-content-center align-items-center text-white">
        <i class="fa-solid fa-user-large px-3"></i>
        ...
        <div class="container-fluid text-white text-center">
            <div class="row d-md-flex align-items-center">
                <div class="col-lg-1 col-2 d-flex align-items-center justify-content-start">
                    <a href="#" class="logo">
                        <img src=" <?php echo base_url('uploads/img/rbssiet new logo.png')?>" class="" alt="">
                    </a>
                </div>
